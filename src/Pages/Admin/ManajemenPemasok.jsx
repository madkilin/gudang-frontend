...
const TABLE_HEAD = ["No", "Tanggal dibuat", "Number", "Nama", "perusahaan", ""];

const ManajemenPemasok = () => {
  ...
  const handleOpen = async (value) => {
    const response = await getPemasokID(value);
  ...
  return (
    <SideBar posisi="Manajemen Pemasok">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <Card className="h-full w-full mt-10">
            <table className="w-full min-w-max table-auto text-left">
              ...
              <tbody>
                {TABLE_ROWS.map(
                  ({ id, number, name, createdAt, perusahaan }, index) => (
      ...
      >
        <DialogHeader>Ubah Pemasok</DialogHeader>
        <DialogBody>
          {datadetail && (
            <div class="max-w-screen-lg mb-2 ">
              <div class="flex flex-col gap-6">
                ...
                <div class="relative h-11 w-full min-w-[200px]">
                  <input
                    placeholder={datadetail.perusahaan}
                    value={datadetail.perusahaan}
                    name="perusahaan"
                    onChange={handleInputChange}
                    class="peer h-full w-full rounded-md border border-blue-gray-200 border-t-transparent !border-t-blue-gray-200 bg-transparent px-3 py-3 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:!border-t-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                  />
        ...
        <DialogFooter>
          ...
          <Button
            ...
            onClick={() => {
              handleOpen(null);
              editPemasokID(datadetail.id, {
                name: datadetail.name,
                perusahaan: datadetail.perusahaan,
      ...
      <Dialog open={hapus} handler={handleOpen2}>
        <DialogHeader>Hapus Pemasok</DialogHeader>
        <DialogBody>
      ...
      <Dialog open={detail} handler={handleOpen3}>
        <DialogHeader>Detail Pemasok</DialogHeader>
        <DialogBody>
          {datadetail && (
            <table className="w-full min-w-max table-auto text-left">
              <tbody>
      ...
      <Dialog
        ...
        className="h-3/4 overflow-y-auto scrollable-content"
      >
        <DialogHeader>Tambah Pemasok</DialogHeader>
        <DialogBody>
          <div class="max-w-screen-lg mb-2 ">
            <div class="flex flex-col gap-6">
              <h6 class="block -mb-3 font-sans text-base antialiased font-semibold leading-relaxed tracking-normal text-blue-gray-900">
...
export default ManajemenPemasok;
